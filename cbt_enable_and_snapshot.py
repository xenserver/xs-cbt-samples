...
snapshot. This script will only need to be run once when first enabling cbt
...
Script will then print out the snapshot uuid before it returns. VDI is saved
to the output path specified
"""
